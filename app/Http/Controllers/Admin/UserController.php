...
class UserController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('admin.users.index', [
            ...
            'roles' => [
                ...
                ...($user?->hasRole(UserRole::Supervisor) ? [] : [UserRole::Supervisor]),
                UserRole::Designer,
                UserRole::Artist,
                UserRole::Info,
                UserRole::Sofor,
    ...
    public function store(Request $request, StudioStaffService $staffService): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'role' => ['required', 'in:admin,yonetici,supervisor,designer,artist,info,sofor,calisan'],
        ...
        if ($request->user()?->hasRole(UserRole::Supervisor) && in_array($validated['role'], ['admin', 'yonetici', 'supervisor'], true)) {
            abort(403);
        }
